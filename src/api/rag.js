...
const SECTION_KEYWORDS = {
  ...
  claims: ['claim', 'real-world', 'procedure', 'volume', 'region', 'utilization', 'prescribing'],
  registries: ['registry', 'registries', 'european liver', 'cirse io', 'quality registry'],
